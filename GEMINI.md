# Mothership for Gemini CLI

This extension installs the `mothership` skill bundle plus vendored superpowers
skills. The entry point is `skills/using-superpowers/SKILL.md` — the same
session-start protocol Claude Code and Codex use.
