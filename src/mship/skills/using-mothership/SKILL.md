...
digraph skill_flow {
    ...
    "Announce once (the skill's own announcement line; else 'Using [skill] to [purpose]')" [shape=box];
    ...
    "Invoke Skill tool" -> "Announce once (the skill's own announcement line; else 'Using [skill] to [purpose]')";
    "Announce once (the skill's own announcement line; else 'Using [skill] to [purpose]')" -> "Has checklist?";
